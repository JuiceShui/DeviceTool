...
public class SimActivity extends AppCompatActivity {
    ...
    void InitProcessThread() {
        ...
        phoneInfoThread = new PhoneInfoThread(SimActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sim_tesyt);
        ...
        switch (requestCode) {
            case PermissionUtil.PERMISSION_REQUEST_CODE:
                if (!PermissionUtil.permissionGranted(this)) {
                    Toast.makeText(SimActivity.this, "需要权限", Toast.LENGTH_SHORT).show();
                } else {
                    // launch();
                    init();
                }
    ...
    private void init() {
        ...
        historyRecycleViewAdapter = new CellnfoRecycleViewAdapter(SimActivity.this, HistoryServerCellList);
